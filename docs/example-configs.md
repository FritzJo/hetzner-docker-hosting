...
To actually start the new instance, please run `./hosting.sh update` again.
...
| Name | File | Notes |
|--|--|--|
|Wordpress|[wordpress-docker-compose.yml](examples/wordpress-docker-compose.yml)||
|Nginx Webserver|[nginx-docker-compose.yml](examples/nginx-docker-compose.yml)||

## How to adapt your own docker-compose files
Basic steps:
